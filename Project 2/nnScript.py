...
#         best_features = mynewlist['best_features']
#         data_1 = {'best_features':best_features, 'n_hidden':50}
...
#         mynewlist = pickle.load(f)
#         best_features = mynewlist['best_features']
#         data_1 = {'best_features':best_features, 'n_hidden':50, 'w1':w1, 'w2':w2}
#         with open('params.pickle','wb') as f1:
#             pickle.dump(data_1, f1)
